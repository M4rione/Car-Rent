...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="widget.html" class="nav-item nav-link"><i class="fa fa-shopping-cart me-2"></i>Transactions</a>
            <a href="form.html" class="nav-item nav-link"><i class="fa fa-file-archive me-2"></i>Reports</a>
